	...
	<div class="row">
		...
		<div class="col s12 m12 l12">
			<div class="card-panel">				
				<h4 class="center">CREAR NORMATIVA</h4>
				<br>
				<form method="POST" action="{{ route('normativas.store') }}" enctype="multipart/form-data">
					{{csrf_field()}}
					<div class="row">
				        ...
				        <div class="center">
							<a href="{{ url()->previous() }}" class="btn grey" onclick="return confirm('¿Deseas cancelar la creación de la normativa?')">Cancelar</a>
